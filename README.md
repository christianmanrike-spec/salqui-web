...
## Personalización (Tweaks)

La página expone tres controles editables en el editor de diseño:

| Prop | Efecto |
| --- | --- |
| `accent` | Repinta el azul de marca en toda la página (hover, pressed y focus-ring se derivan solos). |
| `airiness` | Escala el ritmo vertical de secciones, hero y footer (0.6× – 1.5×). |
| `motion` | Cinematográfico · Sobrio · Estático — regula parallax, reveals, marquesina y halos. |

Toda la animación respeta además `prefers-reduced-motion`.

## Responsive

Dos puntos de quiebre: **860px** (rejillas a 1–2 columnas, se oculta el menú de texto) y **720px** (gutters de 20px, padding vertical reducido, todo a una columna).
